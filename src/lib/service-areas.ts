...
export const SERVICE_AREAS: ServiceArea[] = [
  ...
  },
  {
    ...
    title: "Elopement Photography in Napa & Sonoma",
    ...
    body: [
      ...
      "With gentle planning help on light, timing and flow, your day stays simple, and the photographs hold everything worth remembering.",
    ],
    portfolioCategory: "wedding",
  },
  {
