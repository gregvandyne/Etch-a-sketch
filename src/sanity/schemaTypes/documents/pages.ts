...
export const experiencePageType = defineType({
  ...
  fields: [
      ...
      of: [
        {
          ...
          fields: [
            defineField({
              name: "phase",
              title: "Phase caption",
              description: "The handwritten caption above the photograph, e.g. \"before the wedding\".",
              type: "string",
            }),
    ...
    defineField({
      name: "introAccent",
      title: "Introduction accent line",
      description: "The italic line beneath the introduction, e.g. \"Beautiful photographs. A wedding day you actually get to enjoy.\"",
      type: "string",
      group: "content",
    }),
    defineField({
      ...
      description: "Shown in the panel over the closing photograph.",
      type: "text",
      rows: 6,
      group: "content",
    }),
    defineField({
      ...
      description: "The large caps line beside the closing paragraphs, e.g. \"For couples who want both beauty and breathing room\".",
      type: "string",
      group: "content",
    }),
    defineField({
      name: "closingImage",
      title: "Closing photograph",
      description: "Full-width behind the closing words; shown in black & white.",
      type: "photograph",
      group: "content",
    }),
    seoField,
